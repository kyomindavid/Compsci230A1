...
class Hider extends Player {
	...
	Temperature revealTemperature( Seeker seeker ) {

		double r = getLocation().distance(seeker.getLocation()) / (double) game.gridSize;

		System.out.print( "  " + getName() + " says to " + seeker.getName() + ": " );
		if(r == 0.0) {
	...
	Temperature revealTemperature( HumanSeeker humanSeeker ) {

		double r = getLocation().distance(humanSeeker.getLocation()) / (double) game.gridSize;

		System.out.print( "  " + getName() + " says to " + humanSeeker.getName() + ": " );
		if(r == 0.0) {
			System.out.println("Huckle buckle beanstalk!");
			return Temperature.HUCKLEBUCKLEBEANSTALK;
		} else if(r <= 0.2) {
